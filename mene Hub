...
NameReal.TextColor3 = Color3.fromRGB(255, 0, 0)
...
--  imagenoti.Image = "https://www.roblox.com/asset-thumbnail/image?assetId=7578496318&width=0&height=0&format=png"
    ...
    txdlid.Text = titel
    txdlid.TextColor3 = Color3.fromRGB(255, 0, 0)
...
function top:Taps(text)
    ...
    ScrollingFrame_Pagefrist.ScrollBarImageColor3 = Color3.fromRGB(255, 0, 0) -- 249, 53, 139
...
--     TextLabel_TapDrop.AnchorPoint = Vector2.new(0.5, 0.5)
    ...
    --   ButtonDrop.AnchorPoint = Vector2.new(0.5, 0.5)
        ...
        for i , v in pairs(option) do
            ...
            ListFrame.BackgroundColor3 =  Color3.fromRGB(255, 0, 0)-- Color3.fromRGB(249, 53, 139)
